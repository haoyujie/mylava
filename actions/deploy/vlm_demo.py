...
class VlmDEMODeploy(Deployment):
    """
    ...
    def accepts(cls, device, parameters):
        ...
        if parameters['to'] != 'vlm_demo':
            return False, '"to" parameter is not "vlm_demo"'
        if 'vlm_demo' in device['actions']['deploy']['methods']:
            return True, 'accepted'
        return False, '"vlm_demo" was not in the device configuration deploy methods"'
